...
/// accepted-result carriers are shared across the early materialization phase
/// and the later TU-root emission phase.  Keeping this state in one object avoids

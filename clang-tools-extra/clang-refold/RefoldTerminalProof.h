...
// compact witness/request carriers derived from those facts.  RefoldEngine
// remains responsible for deciding when to request fallback and for owning the
// mutable request list and final raw-B emission path.
//
//===----------------------------------------------------------------------===//

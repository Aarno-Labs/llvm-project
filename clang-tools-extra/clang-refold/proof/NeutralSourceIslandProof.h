...
//
// Source-neutrality proof helpers for preserved zero-token islands.
//
// These helpers prove that source islands such as balanced diagnostic pragma
// state regions and inactive or empty conditional groups are observationally
// neutral when preserved as source text.
//
//===----------------------------------------------------------------------===//

...
//
// RefoldEngine remains responsible for edit emission, line-resync application,
// accepted-result attachment, and terminal-fallback request ownership.
//
//===----------------------------------------------------------------------===//
...
/// proof and B replay envelope, while RefoldEngine remains responsible for
/// converting failures into terminal-fallback requests in the current stage.

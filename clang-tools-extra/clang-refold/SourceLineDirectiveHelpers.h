...
//
// Private source-line directive and trivia helpers shared by the include
// materialization and expansion-fallback engine translation units.  These
// routines used to be visible only because TailUtilities and ExpansionFallback
// were text-included into RefoldEngine.cpp.  Keeping them here preserves the
// same deterministic parsing/rewrite proofs without reintroducing .inc-style
// coupling between the new .cpp files.
//
//===----------------------------------------------------------------------===//

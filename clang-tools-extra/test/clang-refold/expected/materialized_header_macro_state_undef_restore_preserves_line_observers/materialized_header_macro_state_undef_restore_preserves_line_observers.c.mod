...
#line 1 "headers/materialized_header_macro_state_line_observer.h"
#define VAL 99
...
#define VAL 99
#line 6 "headers/materialized_header_macro_state_line_observer.h"
int after_line = __LINE__;
#line 16 "materialized_header_macro_state_undef_restore_preserves_line_observers.c"

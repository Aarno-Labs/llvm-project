// RUN: %clang-refold-tester-with-lines macro_returns_macro_name_then_called_curriedc

// test_chain.c: macro expands to another macro, which then consumes the next argument set.
